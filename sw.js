...
const CACHE_VERSION = 'dj-house-v2026-09-08-1';
...
const APP_SHELL_ASSETS = [
  '/offline.html',
  '/theme-init.js?v=20260908a',
  '/styles.css?v=20260908a',
  '/styles-mobile-overrides.css?v=20260908a',
  '/core.js?v=20260908a',
  '/seo.js?v=20260908a',
  '/site.webmanifest?v=20260908a',
  '/offline.js?v=20260908a',
  '/assets/dj-logo.png',

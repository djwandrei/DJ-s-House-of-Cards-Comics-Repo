...
async function inspectDesktopPage(client, baseUrl, page) {
  ...
  await navigate(client, `${baseUrl}${page.path}${page.path.includes('?') ? '&' : '?'}smokeVersion=20260811a`);
...
async function inspectMobileFlow(client, baseUrl) {
  ...
  await navigate(client, `${baseUrl}/baseball-cards.html?smoke=mobile&smokeVersion=20260811a`);

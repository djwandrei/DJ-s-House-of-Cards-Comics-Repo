...
import {
  ...
  parsePlayerCsv,
  validateDataset,
} from "./player-data.js?v=20260905b";
import {
  ...
  nbaSeasonLabel,
} from "./supabase-nba-data.js?v=20260905b";
import {
  derivePlayerRateViews,
  explainOptimizationSelection,
} from "./fan-analytics.js?v=20260905b";
import {
  buildOpponentGamePlan,
} from "./opponent-gameplan.js?v=20260905b";
import {
  decodeScenarioQuery,
  encodeScenarioQuery,
} from "./scenario-url.js?v=20260905b";
import { pruneLineupLabDatasetCache } from "./lineup-cache.js?v=20260905b";
...
const FIXTURE_URL = "./fixtures/timberwolves-2021-22.json?v=20260905b";
const OPTIMIZER_WORKER_URL = new URL("./optimizer-worker.js?v=20260905b", import.meta.url);

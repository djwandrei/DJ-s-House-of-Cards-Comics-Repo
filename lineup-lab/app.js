...
import {
  ...
  parsePlayerCsv,
  validateDataset,
} from "./player-data.js?v=20260831a";
import {
  fetchSupabaseNbaTeamDataset,
  listSupabaseNbaSeasons,
  listSupabaseNbaTeams,
  nbaSeasonLabel,
} from "./supabase-nba-data.js?v=20260831a";
import {
  derivePlayerRateViews,
  explainOptimizationSelection,
  FAN_ROLE_DEFINITIONS,
} from "./fan-analytics.js?v=20260831a";
import {
  decodeScenarioQuery,
  encodeScenarioQuery,
} from "./scenario-url.js?v=20260831a";
import { pruneLineupLabDatasetCache } from "./lineup-cache.js?v=20260831a";
...
const FIXTURE_URL = "./fixtures/timberwolves-2021-22.json?v=20260831a";
const OPTIMIZER_WORKER_URL = new URL("./optimizer-worker.js?v=20260831a", import.meta.url);

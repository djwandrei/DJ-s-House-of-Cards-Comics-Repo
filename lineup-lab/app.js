...
import {
  ...
  parsePlayerCsv,
  validateDataset,
} from "./player-data.js?v=20260901e";
import {
  fetchSupabaseNbaTeamDataset,
  listSupabaseNbaSeasons,
  listSupabaseNbaTeams,
  nbaSeasonLabel,
} from "./supabase-nba-data.js?v=20260901e";
import {
  derivePlayerRateViews,
  explainOptimizationSelection,
} from "./fan-analytics.js?v=20260901e";
import {
  buildOpponentGamePlan,
} from "./opponent-gameplan.js?v=20260901e";
import {
  decodeScenarioQuery,
  encodeScenarioQuery,
} from "./scenario-url.js?v=20260901e";
import { pruneLineupLabDatasetCache } from "./lineup-cache.js?v=20260901e";
...
const FIXTURE_URL = "./fixtures/timberwolves-2021-22.json?v=20260901e";
const OPTIMIZER_WORKER_URL = new URL("./optimizer-worker.js?v=20260901e", import.meta.url);
...
function syncRotationModelControls() {
  ...
  elements.rotationRateStabilityHelp.textContent = usesPer36Rates
    ? "Recommended adjusts uncertain rates toward the same-season baseline when a player is asked to handle more responsibility. Playing more minutes does not automatically mean star-level usage. Games or total minutes with the selected team never set the new minute plan."
...
function buildOptimizerConfig() {
  ...
  if (config.mode === "rotation") {
    config.rotationOptions = {
      ...
      // The public page stays Historical until a complete, verified dataset is
      // delivered; missing Scout rows are never interpreted as league average.

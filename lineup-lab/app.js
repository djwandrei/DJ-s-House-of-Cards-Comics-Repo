...
import {
  ...
  parsePlayerCsv,
  validateDataset,
} from "./player-data.js?v=20260905a";
import {
  ...
  nbaSeasonLabel,
} from "./supabase-nba-data.js?v=20260905a";
import {
  derivePlayerRateViews,
  explainOptimizationSelection,
} from "./fan-analytics.js?v=20260905a";
import {
  buildOpponentGamePlan,
} from "./opponent-gameplan.js?v=20260905a";
import {
  decodeScenarioQuery,
  encodeScenarioQuery,
} from "./scenario-url.js?v=20260905a";
import { pruneLineupLabDatasetCache } from "./lineup-cache.js?v=20260905a";
...
const FIXTURE_URL = "./fixtures/timberwolves-2021-22.json?v=20260905a";
const OPTIMIZER_WORKER_URL = new URL("./optimizer-worker.js?v=20260905a", import.meta.url);

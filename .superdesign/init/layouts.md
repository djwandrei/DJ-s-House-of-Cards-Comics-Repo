# Shared layouts and shells

## Architecture note

The site is a **vanilla static HTML/JavaScript multi-page application**, not a component-framework app. There is no single `Layout.tsx`, application shell component, or router layout. The storefront header and footer are repeated HTML regions in the static pages; `nav.js` and `core.js` turn that repeated markup into the responsive, accessible shared shell.

The Lineup Lab source is a dedicated, intentionally separate tool shell in `prototypes/basketball-lineup-optimizer/`. This document uses source files only and deliberately does not treat generated `lineup-lab/` release output as the design source.

## Storefront header markup

- Source: `index.html`
- Description: representative complete shared header block; category pages use the same `.site-header` / `#siteNav` contract.
- Runtime: `core.js` enhances the action cluster/theme control, and `nav.js` owns active state, mobile drawer behavior, submenu interaction, focus movement, and dismissal.

```html
<header class="site-header">
<div class="container header-inner">
    <a aria-label="DJ's House of Cards &amp; Comics &bull; Trusted Hobby Finds home" class="brand" href="index.html">
<img alt="DJ's House of Cards &amp; Comics logo" class="brand-logo" decoding="async" fetchpriority="high" height="84" src="assets/dj-logo.png" width="84"/>
<span class="brand-copy">
<span class="brand-script">
       DJ's House of Cards
      </span>
<span class="brand-kicker">
       &amp; Comics &bull; Trusted Hobby Finds
      </span>
</span>
</a>
<nav aria-label="Primary navigation" class="site-nav" id="siteNav">
...
<button aria-controls="siteNav" aria-expanded="false" class="nav-toggle" id="navToggle" type="button">
     Menu
    </button>
<button aria-label="Toggle color theme" class="theme-toggle theme-toggle--compact" id="themeToggle" type="button">
     Dark Mode
    </button>
</div>
</header>
...
## Storefront footer markup

- Source: `index.html`
- Description: representative complete shared footer block. `core.js` groups its links and enhances direct-contact/scroll-to-top behavior.
...
<img alt="DJ's House of Cards &amp; Comics logo" class="footer-logo" decoding="async" height="72" loading="lazy" src="assets/dj-logo.png" width="72"/>
<div>
...
<p>
      Curated sports cards, comics, and collectibles for buyers who enjoy the hunt.
     </p>
</div>
...
<a href="collectibles.html">
      Collectibles
     </a><a class="footer-marketplace-link" data-footer-group="storefronts" href="https://www.whatnot.com/user/djshouseofcards" rel="noopener noreferrer" target="_blank">Whatnot</a><a class="footer-marketplace-link" data-footer-group="storefronts" href="https://xy2hik-nq.myshopify.com/" rel="noopener noreferrer" target="_blank">Shopify Store</a><a class="footer-marketplace-link" data-footer-group="storefronts" href="https://www.tiktok.com/@djshouseofcards/shop" rel="noopener noreferrer" target="_blank">TikTok Shop</a>
<a href="wishlist.html">
      View wishlist
      <span data-wishlist-count="0">
       0
      </span>
</a>
<a href="about.html">
...
<a href="sell-trade-want-list.html">
...
<span>
     &copy; 2026 DJ's House of Cards &amp; Comics. All rights reserved.
    </span>
</div>
</footer>
```

## Shared primary navigation controller

- Source: `nav.js`
- Description: full shared shell controller. It exports the static-page navigation map on `window.DJ`, marks current pages, manages the compact drawer, handles submenu pointer/keyboard behavior, keeps focus contained while the drawer is open, and cleans up state across viewport changes.
...
- Source: `core.js`
- Description: full global `window.DJ` runtime. Its shell-facing responsibilities include header composition, cart-count placement, persistent light/dark mode, responsive placement of the theme control, footer grouping, status/focus helpers, lazy image behavior, and service-worker initialization. The module also contains shared storefront utilities because this static site has no separate component/service layer.
...
(() => {
  ...
  const PRODUCT_ASSET_VERSION = '20260824d';
...
- Source: `prototypes/basketball-lineup-optimizer/index.html`
- Description: a dedicated tool header/footer outside the storefront primary navigation. It provides a clear return link to the storefront, keeps the beta status visible, and holds a separate live-status toast.

### Header

```html
<header class="lab-header">
    <div class="shell lab-header__inner">
      <a class="brand" href="../../index.html" aria-label="Return to DJ's House of Cards and Comics">
        <img src="../../assets/dj-logo.png" width="56" height="56" alt="" decoding="async">
        <span>
          <strong>DJ's Lineup Lab</strong>
          <small>NBA lineup optimizer</small>
        </span>
      </a>
      <span class="prototype-badge">Public beta</span>
    </div>
  </header>
```
...
<footer class="lab-footer">
    <div class="shell">
      <p><strong>DJ's Lineup Lab</strong> - historical NBA tools from DJ's House of Cards &amp; Comics.</p>

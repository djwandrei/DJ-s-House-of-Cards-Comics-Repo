// Preview-only design tokens. Not imported by the storefront or optimizer.
...
export const sourceNotes = {
  ...
  status: 'Design review only; no production theme changes',
  exceptions: {
...
export function paletteForTeam(teamId) {
  const id = typeof teamId === 'string' ? teamId.trim().toLowerCase() : '';

-- Expand the validated Scout Daily Games catalog from the original 2024-26
-- release window to the complete 2020-26 source package.  This is a forward
...
alter table public.nba_scout_daily_game_scopes
  add constraint nba_scout_daily_game_scopes_source_season_end_years_2020_26_check
  check (
    cardinality(source_season_end_years) between 1 and 6
    and source_season_end_years <@ array[2021, 2022, 2023, 2024, 2025, 2026]::smallint[]
...
alter table public.nba_scout_daily_game_players
  add constraint nba_scout_daily_game_players_source_season_end_year_2020_26_check
  check (source_season_end_year between 2021 and 2026);
...
begin
  ...
  if cardinality(v_seasons) not between 1 and 6
    or not (v_seasons <@ array[2021, 2022, 2023, 2024, 2025, 2026]::smallint[]) then
